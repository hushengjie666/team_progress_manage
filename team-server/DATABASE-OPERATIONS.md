...
4. Start the backend service and verify `/health` returns `release_version: 0.2.8`, `api_protocol_version: 1`, `database_schema_version: 11`, and `minimum_client_release: 0.2.8`.
