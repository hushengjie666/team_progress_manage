...
```sh
git switch -c release/v0.2.7
git push -u origin release/v0.2.7
bash scripts/create-timemanage-release-tag.sh v0.2.7 "TimeManage Team v0.2.7"
git push origin v0.2.7
git switch main
git merge --ff-only release/v0.2.7
git push origin main
git branch -d release/v0.2.7
git push origin --delete release/v0.2.7
```

从指定 tag 打包：

```sh
npm run release:team:tag -- v0.2.7
```
...
```text
timemanageTeam-v0.2.7-20260818-153000.zip
timemanageTeam-v0.2.7-20260818-153000/
```
...
```text
C:/Users/Administrator/Desktop/timemanageTeam/
C:/Users/Administrator/Desktop/timemanageTeam-v0.2.7-20260818-153000/
```
...
```text
C:/Users/Administrator/Desktop/timemanageTeam-v0.2.7-20260818-153000/desktop/
C:/Users/Administrator/Desktop/timemanageTeam-v0.2.7-20260818-153000/RELEASE.txt
C:/Users/Administrator/Desktop/timemanageTeam-v0.2.7-20260818-153000/web/index.html
C:/Users/Administrator/Desktop/timemanageTeam-v0.2.7-20260818-153000/server/timemanage-team.exe
C:/Users/Administrator/Desktop/timemanageTeam-v0.2.7-20260818-153000/server/backend.example.json
C:/Users/Administrator/Desktop/timemanageTeam-v0.2.7-20260818-153000/server/start-backend.bat
```
...
3. 在 Desktop 下解压，确认出现同名版本目录，例如 `timemanageTeam-v0.2.7-20260818-153000/`。
