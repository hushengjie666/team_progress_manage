...
func businessLoadRowsForProjects(ctx context.Context, q sqlRunner, workspaceID string, projectIDs []string) ([]businessRow, error) {
	...
	return append(append(append(append(append(append(projectRows, projectMemberRows...), taskRows...), workSessionRows...), executionSignalRows...), focusSessionRows...), interruptionRows...), nil
}
